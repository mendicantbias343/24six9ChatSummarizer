<template>
    <div class="flex flex-col justify-center items-start px-3 w-full">
      ...
      >
        <div  v-bind:class="previous_date?'next cursor-pointer':'next cursor-pointer grayscale'"><a v-bind:href="previous_date">⏮️</a></div>
        <div class="current-date w-4/5 text-center text-lg">
          {{ formattedDate}}
        </div>
        <div   v-bind:class="next_date ? 'next cursor-pointer' : 'next cursor-pointer grayscale'"><a v-bind:href="next_date">⏭️</a></div>
      </div>
